...
> Default: Empty
> Example: `+llama,+claude-2,-gpt-3.5-turbo,gpt-4-0125-preview=gpt-4-turbo` means add `llama, claude-2` to model list, and remove `gpt-3.5-turbo` from list, and display `gpt-4-0125-preview` as `gpt-4-turbo`.
